...
CREATE TABLE `POST` (
	`POST_SEQ`	INT	NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
SELECT POST_SEQ, POST_INFO_ID, POST_TITLE, POST_CONTENTS, POST_DESCRIPTION, IS_MAIN, CREATE_DATE, CREATE_USER, UPDATE_DATE, UPDATE_USER, USE_YN FROM POST WHERE 1=1;
INSERT INTO POST(
			POST_SEQ,
			POST_INFO_ID,
			POST_TITLE,
